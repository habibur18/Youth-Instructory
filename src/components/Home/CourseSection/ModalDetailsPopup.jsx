    ...
    <div className={`bg-white p-7 rounded-md overflow-y-auto ${isMobile ? "h-screen sm:h-auto" : "h-full"}`}>
      <div className="max-w-[700px] mx-auto modal-content">
        <div className="border relative">
          ...
          <i onClick={closeModal} className="absolute top-0 right-0 z-50 text-white bg-gray-800/80 px-4 py-2 rounded-tr-xl text-xl hover:bg-gray-900 duration-300 cursor-pointer fa-solid fa-xmark"></i>
        </div>
