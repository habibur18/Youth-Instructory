...
export default function Sidebar({ isSideBarOpen, setIsSideBarOpen }) {
  ...
  return (
    <div className={`fixed  transition-opacity duration-700 ${isSideBarOpen ? "opacity-100 bg-gray-800/30  inset-0" : "pointer-events-none min-h-0 min-w-0"}`}>
      ...
      <div ref={courseRef} className={`All-Courses-sub-menu fixed inset-y-0 w-3/6 bg-[#212529] transition-transform duration-700 translate-x-full ${isCoursesOpen ? "translate-y-0" : ""}`}>
